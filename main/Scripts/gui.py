...
def submit():
    ...
    price = price_var.get()
    closing_date = closing_date_var.get()
    ...
    closing_date_default = closing_date_default_var.get()
    ...
    fields_to_validate = [
        ...
        (closing_date, closing_date_default),
        ...
        (earnest_money, False),  # Earnest Money doesn't have a default option
...
Label(app, text="Closing Date:").grid(row=5, column=0)
...
closing_date_entry = Entry(app, textvariable=closing_date_var, width=entry_width)
...
closing_date_entry.grid(row=5, column=1)
...
closing_date_default_var = tk.BooleanVar()
...
Checkbutton(app, text="Default", variable=closing_date_default_var, command=lambda: toggle_entry_state(closing_date_entry, closing_date_default_var)).grid(row=5, column=2)
